...
The approved holding composition is the existing mark-only header and the live
Canonical Brand Reference 01 hero, with no hero calls to action and the login control placed in the
