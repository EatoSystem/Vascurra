...
export function Veya() {
  return <section id="veya" aria-labelledby="veya-heading" className={styles.section}>
    <div className={`${styles.inner} ${styles.split}`}>
      ...
      <figure className={styles.veyaArtwork}>
        <Image
          src="/vascurra/homepage/candidates/ethereal_aqua_guardian_in_flowing_ribbons.webp"
          alt="An abstract human form rises from calm flowing ribbons, suggesting guidance and clarity."
          width={1672}
          height={941}
